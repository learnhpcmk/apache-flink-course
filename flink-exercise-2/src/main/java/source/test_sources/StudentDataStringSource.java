...
public class StudentDataStringSource implements SourceFunction<String> {
    ...
    public StudentDataStringSource() {
    ...
    public void run(SourceContext<String> ctx) throws Exception {
        for (int i = 0; i < nOfRecords; i++) {
            ...
            ctx.collect(String.format("%s %s %d", index, course, random.nextInt(80)+20));
